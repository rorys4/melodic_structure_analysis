...
do
    ...
    python3 analyse_melodic_structures.py -m $x -o $output_filename
    
    # Capture the output of the second Python program
    result=$(python3 /home/roro/Documents/RA2/code/compare_results/compare_with_doherty.py -i $output_filename)
